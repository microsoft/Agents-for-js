 ...
 */
export class TestPlanner implements Planner<AITurnState> {
  /**
  ...
  /**
     ...
     * @param {AITurnState} state Application state for the current turn of conversation.
     * @param {AI<AITurnState>} ai The AI system that is generating the plan.
     * @returns {Promise<Plan>} The plan that was generated.
     */
  public beginTask (context: TurnContext, state: AITurnState, ai: AI<AITurnState>): Promise<Plan> {
  ...
  /**
     ...
     * @returns {Promise<Plan>} The plan that was generated.
     */
  public continueTask (context: TurnContext, state: AITurnState, ai: AI<AITurnState>): Promise<Plan> {
