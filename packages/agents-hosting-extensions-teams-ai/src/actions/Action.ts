 ...
 */
export type ActionHandler<TState extends AITurnState = AITurnState, TData = any> = (
  context: TurnContext,
  state: TState,
  data: TData,
  action?: string
 ...
 * @private
 */
export interface ActionEntry<TState extends AITurnState = AITurnState, TData = any> {
