...
export class FunctionCallMessage extends PromptSectionBase {
  ...
  /**
     ...
     * @param {FunctionCall} functionCall name and arguments of the function to call.
     ...
     */
  public constructor (functionCall: FunctionCall, tokens: number = -1, assistantPrefix: string = 'assistant: ') {
    super(tokens, true, '\n', assistantPrefix)
