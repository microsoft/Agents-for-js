 ...
 * @param {any} payload The incoming payload object to normalize.
 * @returns {object} The normalized payload object with `bot` replaced by `agent` in `relatesTo`.
 */
 ...
 * This ensures compatibility with the activity wire protocol.
 * @private
 * @param {any} payload The outgoing payload object to normalize.
 * @returns {object} The normalized payload object with `agent` replaced by `bot` in `relatesTo`.
 */
...
/**
 * Normalizes a token exchange payload by converting the `agent` property in `conversation` to `bot`.
 * @param {any} payload The token exchange payload object to normalize.
 * @returns {object} The normalized token exchange payload with `agent` replaced by `bot` in `conversation`.
 */
