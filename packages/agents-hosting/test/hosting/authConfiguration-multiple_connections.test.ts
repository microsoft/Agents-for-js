...
describe('AuthConfiguration', () => {
  ...
  beforeEach(() => {
    ...
    process.env.CONNECTIONS__SERVICECONNECTION__SETTINGS__CERTPEMFILE = 'test-cert-pem-file'
    process.env.CONNECTIONS__SERVICECONNECTION__SETTINGS__CERTKEYFILE = 'test-cert-key-file'
  ...
  describe('loadAuthConfigFromEnv in new multi-config style without connection name', () => {
    it('should load configuration from environment variables', () => {
      ...
      assert.strictEqual(config.certPemFile, 'test-cert-pem-file')
      assert.strictEqual(config.certKeyFile, 'test-cert-key-file')
