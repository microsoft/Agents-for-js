...
import { Activity, AttachmentLayoutTypes, CardAction, InputHints } from '../../../agents-bot-activity'
...
describe('MessageFactory', { timeout: 5000 }, function () {
  ...
  it('should return suggestedActions().', function () {
    ...
    assertMessage(activity)
    assert((activity.suggestedActions != null) && activity.suggestedActions.actions, 'actions not returned')
