...
import { ActionTypes, AppBasedLinkQuery, Attachment, CardAction, CardFactory, CardImage, HeroCard, MessageFactory, MessagingExtensionAttachment, MessagingExtensionQuery, MessagingExtensionResponse, TaskModuleAction, TaskModuleRequest, TaskModuleResponse, TaskModuleTaskInfo, TeamsActivityHandler, TeamsInfo, ThumbnailCard, TurnContext } from '@microsoft/agents-bot-hosting'
