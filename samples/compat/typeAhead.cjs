...
class TeamsBot extends TeamsActivityHandler {
  ...
  async handleMessage (context, next) {
    ...
    if (text) {
      switch (text) {
        case 'staticsearch':
          await context.sendActivity(MessageFactory.attachment(CardFactory.adaptiveCard(this.getStaticSearchCard())))
          break
        case 'dynamicsearch':
          await context.sendActivity(MessageFactory.attachment(CardFactory.adaptiveCard(this.getDynamicSearchCard())))
          break
        case 'dependantdropdown':
          await context.sendActivity(MessageFactory.attachment(CardFactory.adaptiveCard(this.getDependantSearchCard())))
          break
        default:
